                                 ...
                                 size_t text_count)
{
    ...
    m_shape_registry.push_back(ShapeRecord{type, segment_offset, segment_count, curve_offset, curve_count, text_offset, text_count}); // NOLINT(modernize-use-designated-initializers)
    ++m_nshape;
